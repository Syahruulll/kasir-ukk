...
<div class="page-wrapper">
    <!-- Penjualan kanan sidebar toggle -->
    ...
    @if (Session::get('success'))
        ...
        @endif
    <!-- End Penjualan kanan sidebar toggle-->
    <!-- Container fluid  -->
...
<script>
    ...
    if (totalPay < total) {
        ...
        submitButton.disabled = true; //nonaktif tombol submit
    } else {
        errorMessage.classList.add('d-none');
        submitButton.disabled = false; // mengaktifkan submit tombol
    }
}

// memberi tau kalo jumlah pembayaran cukup dan gacukup
document.querySelector('form').addEventListener('submit', function(event) {
    ...
    if (totalPay < total) {
        ...
        alert('Jumlah bayar kurang!'); // tampilkan pemberitahuan jika uang kurang
    }
});
